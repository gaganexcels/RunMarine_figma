...
const vesselTypes = [
  ...
  },
  {
    ...
    description: 'Agility meets capability. Designed for flexible operations across diverse global ports.',
    imageUrl: 'https://images.unsplash.com/photo-1758900348926-cd1ccbc15fef?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    features: ['Port Flexibility', 'Regional Trade', 'Multi-Purpose'],
  },
  {
    name: 'Ultramax',
    slug: 'ultramax',
  ...
  },
  {
    name: 'VLOC',
    slug: 'vloc',
    dwt: '200,000 - 400,000 DWT',
    description: 'Very Large Ore Carriers. Unmatched capacity for bulk mineral transport across continents.',
    imageUrl: 'https://images.unsplash.com/photo-1585713181935-d5f622cc2415?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
    features: ['Ore Transport', 'Ultra-Capacity', 'Long Haul'],
  },
  {
    name: 'Mini Bulker',
    slug: 'mini-bulker',

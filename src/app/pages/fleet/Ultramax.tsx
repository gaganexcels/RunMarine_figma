...
const specifications = [
  { label: 'Deadweight Tonnage', value: '60,000 - 65,000 DWT' },
  { label: 'Length Overall', value: '199 - 200 meters' },
  { label: 'Beam', value: '32.2 meters' },
  { label: 'Draft', value: '12 - 14 meters' },
  { label: 'Cargo Hold Capacity', value: '78,000 - 82,000 m³' },
  { label: 'Speed (Service)', value: '14.5 knots' },
];
...
const capabilities = [
  ...
  {
    icon: Globe,
    title: 'Eco-Efficient Performance',
    description: 'Advanced hull design and modern engine technology deliver significant fuel savings and reduced emissions compared to traditional vessels.',
  },
  {
    icon: Gauge,
    title: 'Optimized Operations',
    description: 'Equipped with energy-saving devices and sophisticated cargo handling gear for maximum operational efficiency.',
  },
  {
    icon: Anchor,
    title: 'Universal Port Access',
    description: 'Ideal dimensions for accessing a vast network of global ports while offering superior cargo capacity in its class.',
  },
];
...
export function Ultramax() {
  return (
    <div className="min-h-screen bg-[#F8F7F4]">
      <PageHero
        title="Ultramax"
        subtitle="Premium Handymax evolution with enhanced efficiency. The ultimate in adaptable vessel design."
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-[#6B7280] leading-relaxed">
              Ultramax vessels represent the cutting edge of Handymax design philosophy. These modern
              workhorses combine enhanced cargo capacity with superior fuel efficiency, making them the
              preferred choice for operators seeking versatility without compromising on environmental
              performance or economic returns.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-lg text-white/80 leading-relaxed mb-8">
              Our Ultramax fleet embodies our commitment to sustainable maritime operations. With advanced
              emission control systems, optimized voyage planning, and continuous performance monitoring,
              these vessels deliver exceptional efficiency while minimizing environmental impact. Every
              journey is managed with precision to ensure both economic and ecological responsibility.
            </p>
            <div className="grid md:grid-cols-3 gap-6 mt-12">
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
                <div className="text-3xl font-bold text-[#B8860B] mb-2">20%</div>
                <div className="text-white/80">Lower Emissions</div>
              </div>
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
                <div className="text-3xl font-bold text-[#B8860B] mb-2">65K</div>
                <div className="text-white/80">DWT Capacity</div>
              </div>
              <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
                <div className="text-3xl font-bold text-[#B8860B] mb-2">IMO</div>
                <div className="text-white/80">Tier III Compliant</div>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h2
              ...
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              Charter an Ultramax Vessel
            </h2>
            <p className="text-lg text-white/90 mb-8 leading-relaxed">
              Discover the advantages of modern, eco-efficient shipping with our Ultramax fleet.
